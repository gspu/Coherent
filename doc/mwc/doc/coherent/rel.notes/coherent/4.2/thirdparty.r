...
.PP
Your \*(CO package included a catalogue of third-party software
that describes some of the third-party products available for \*(CO.
You can order these through Mark Williams Company by using the order form
in the middle of the catalogue.
Or, if you prefer, you can telephone the Mark Williams sales department at
1-800-636-6700 or 1-708-291-6700, or you can FAX us your order
at 1-708-291-6750.
Members of the \*(CO Club receive special discounts on most items.
The \*(CO command
.B phone
...
the \*(CO port of GNU C/C++;
source code for GNU C/C++;
and GNU Tools, a collection of GNU tools and utilities ported to \*(CO.
An order form is available in the catalogue
...
you can open multiple windows on your screen, and use icons,
pop-up menus, graphics on your \*(CO system.
.PP
...
.PP
Note that X Windows for \*(CO requires four megabytes of RAM (eight is
preferred), a serial mouse, and a VGA video card and monitor.
.PP
...
This software can be downloaded freely from our BBS.
However, assuming that you have a 2400-baud modem,
downloading can easily cost $30 per megabyte, not to
mention the time and inconvenience.
So, we have come up with the answer:
COHware!
.PP
...
.so /v/fwb/coherent/rel.notes/coherent/coh4.2/contents.CW3.r
.PP
COHware volume IV contains the following:
.so /v/fwb/coherent/rel.notes/coherent/coh4.2/contents.CW4.r
.PP
COHware volume V contains the following:
.so /v/fwb/coherent/rel.notes/coherent/coh4.2/contents.CW5.r
.PP
...
including source code for over a dozen \*(CO drivers.
The Kit brings a new level of support
for writing drivers and has greater detail than UNIX versions.
.PP
Release 4.2 of the Kit documents the \*(CO implementation of
...
Like all Mark Williams software, our Device Driver Kit is extremely affordable.
Use the form at the end of this manual to order the
best value in driver kits \(em yet one more reason why
\*(CO is on the way to becoming the most widely used PC-based
development system in the world.
.SH "GNU C and GNU Tools"
.PP
Mark Williams Company offers
.BR "GNU C" ,
from the Free Software Foundation.
GNU C offers full support for the ANSI C standard, plus numerous extensions
and features not found in most C compilers.
.\" Including ours.
It also implements a full-featured implementation of the C++ language,
with which you can explore the world of C++ and object-oriented
programming, all under your \*(CO system.
With
.BR "GNU C" ,
...
.BR "GNU C Source Kit" .
This gives full sources to GNU C and its libraries
in a ready-to-compile form.
With it, you can rebuild GNU C on your system and study the design of
this major piece of software.
Note that the
.B "GNU C Source Kit"
requires that you have
.BR "GNU C" .
.PP
Finally, Mark Williams offers
.BR "GNU Tools" ,
a set of tools from the Free Software Foundation.
.B "GNU Tools"
includes the following:
.so /v/fwb/coherent/rel.notes/coherent/coh4.2/contents.GW1.r
.PP
.B "GNU C"
costs only $79.95.
.B "GNU Tools"
...
Members of the \*(CO Club save even more.
.PP
We know how you value Mark Williams Company's commitment to user support.
However, because of the nature of these products, we cannot
offer technical support on the Device Driver Kit, COHware, GNU Tools,
or GNU C.
...
For a listing of the discounts you can receive, see the order form
at the back of this pamphlet.
.PP
To join, fill out the form at the end of these notes, or you can call
1-800-636-6700 or 1-708-291-6700.
.SH "Third-Party Software Packages for COHERENT 4.2"
.PP
What follows is a preliminary list of companies that have ported their
...
1-403-436-2999 (FAX)
.fi
.IP "\fBSequoia Software\fR"
.nf
Motif for \*(CO (window manager)
305-784-9576 (voice)
305-784-0324 (FAX)
.fi
.IP "\fBSINC Inc.\fR"
...
.BR /pub/coherent .
.PP
For other sources of shareware and public-domain software,
see the bulletin boards listed in the next section of these notes.
