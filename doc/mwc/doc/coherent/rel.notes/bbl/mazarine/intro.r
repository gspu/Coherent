...
.PP
The following document describes how to install the Cardinal Mazarine
...
.BR troff .
.SH "Installing Cardinal Mazarine"
.PP
The Cardinal Mazarine package consists of files compressed by the GNU
utility
.BR gzip ,
and are stored on a
.B tar
...
command line.
.PP
For example, assume that you have installed the Cardinal Mazarine
into directory
.BR /usr/bbl .
...
.vs 9p
	...
	This mass of text precedes the image.
	This mass of text precedes the image:
	.PH 1 1 /usr/bbl/mazarine/cmz.bnd
	.PP
...
Example call:
.DM
	.PB 1 1 /usr/PostScript/bbl/pj12.bnd
.DE
.IP \fB.PR\fR
...
Example call:
.DM
	.PR 1 1 /usr/PostScript/bbl/pj12.bnd
.DE
.PP
