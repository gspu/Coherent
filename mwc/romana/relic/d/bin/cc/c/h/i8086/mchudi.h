 ...
 * This one produces a COHERENT-resident !TINY UDI compiler
 * which does both models and uses the 8087 with emulation fixups.
 */
#define	DATE		"11/18/87"	/* Date			*/
#define	VERSMWC		"V3.0.2"	/* MWC version number	*/
#define	VERSINT		"X317"		/* Intel version number	*/
...
#define	NDP		1	/* 8087?			*/
#define	EMUFIXUPS	1	/* M: 8087 emulation fixups?	*/
