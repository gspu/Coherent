 ...
 * This one produces a COHERENT-resident !TINY UDI 80286 compiler
 * which does both models and uses the 8087.
 */
#define	DATE		"1/22/87"	/* Date */
#define	VERSMWC		"V2.7.1"	/* MWC version number */
#define	VERSINT		"X314"		/* Intel version number */

#define	EATDOL		1	/* Eat '$' in identifiers? */
...
#define AS_FORMAT	0	/* Coherent/Rainbow .s format? */
#define	INTEL		1	/* Intel copyright? */
#define	OMF286		1	/* 286 object format? */
#define	TEMPBUF		0	/* Memory tempfile buffers? */

#define	NDP		1	/* 8087? */
#define	EMULATION	0	/* Use M: links? */
...
#define	UIMASK	037777600000L	/* Unsigned long check mask */
#define	SIMASK	037777700000L	/* Signed long check mask */
#define	ASMASK	0177777L	/* Address space mask */
