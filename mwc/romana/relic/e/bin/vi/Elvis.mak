...
elvprsv.exe: elvprsv.c prsvdos.c wildcard.c ctype.obj
	$(CC) $(CFLAGS) elvprsv.c ctype.obj -o elvprsv.exe

wildcard.exe: wildcard.c ctype.obj
	$(CC) wildcard.c ctype.obj -o wildcard.exe
