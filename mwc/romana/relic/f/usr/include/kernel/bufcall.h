...
/*
 * This header file contains a number of definitions aimed at working around
 * the enormous problems generated by the existence of callback functions
 * as implemented by bufcall (), ie without argument checking. See the
 * definition of the str_event structure in <sys/strmlib.h> for a more
 ...
 * lossage.
 *
 * Since the only genuinely safe way of doing this is via the use of stdargs
 ...
 * cast.
 *
 * In order to make the job of declaring potential fully-type-safe versions
 * of the forwarding function, we provide a template-style macro that users
 * can try and use.
 */
