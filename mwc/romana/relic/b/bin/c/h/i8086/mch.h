...
#define	APPENDBAR	1	/* Append '_' to identifiers?	*/
...
#define	I_FMT	"%d"		/* printf format for ival_t con */
#define	I_FMTX	"%x"		/* printf format for ival_t con */
#define	NBPBYTE	8		/* # of bits in a "byte" */
#define	saligntype(ip)	1	/* align structs to char boundaries */
