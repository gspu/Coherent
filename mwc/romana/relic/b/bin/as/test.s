...
abc:
	...
	incw	0x3e8	/ 0121 ffffff00
	incl	%ecx	/ 0122 ffffff00
	larw	%bx, %si	/ 0009 0002
	larl	0x3e8, %edi	/ 000a 0002
	...
	popw	%fs	/ 0008 00a1
	popw	%gs	/ 0008 00a9
	popw	(, %ecx, 4)	/ 0021 ffff8f00
	popl	(%eax)	/ 0022 ffff8f00
	popaw		/ 0001 0061
	popal		/ 0002 0061
	popfw		/ 0001 009d
	popfl		/ 0002 009d
	...
	pushw	%fs	/ 0008 00a0
	pushw	%gs	/ 0008 00a8
	pushw	0x64(%si)	/ 0021 ffffff06
	pushl	0x64(%bp, %di)	/ 0022 ffffff06
	pushaw		/ 0001 0060
	pushal		/ 0002 0060
	pushfw		/ 0001 009c
	pushfl		/ 0002 009c
	rclb	$1, %bl	/ 0020 ffffd002
	rclb	0x64(%bp)	/ 0020 ffffd002
	rclb	%cl, %al	/ 0020 ffffd202
	rclb	$0x64, (%bp, %di)	/ 0020 ffffc002
	rclw	$1, 0x64(%si)	/ 0021 ffffd102
	rclw	%dx	/ 0021 ffffd102
	rclw	%cl, 0x64(%di)	/ 0021 ffffd302
	rclw	$0x64, %si	/ 0021 ffffc102
	rcll	$1, %esp	/ 0022 ffffd102
	rcll	(%bx)	/ 0022 ffffd102
	rcll	%cl, %eax	/ 0022 ffffd302
	rcll	$0x64, 0x3e8	/ 0022 ffffc102
	rcrb	$1, %al	/ 0020 ffffd003
	rcrb	0x3e8	/ 0020 ffffd003
