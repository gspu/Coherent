 ...
 * including only commands which the troff PCL output writer writes.
...
extern	void	esc_param( /* int c */			);
extern	void	esc_two( /* int c */			);
extern	void	fatal(	/* char *fmt, ... */		);
extern	void	lookup( /* int c, int group, double val, int param */ );
extern	FILE	*openfile( /* char *name, char *mode */ );
extern	void	usage(	/* void */			);
extern	double	value(	/* void */			);
...
error(fmt) char *fmt;
{
	...
	fprintf(stderr, "readPCL: unrecognized ESC sequence: ESC %r", &fmt);
}
