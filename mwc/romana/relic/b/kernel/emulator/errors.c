...
#ifdef DEBUGGING
if ( status_word & SW_B ) printf("SW: backward compatibility (=ES)\n");
...
if ( status_word & SW_ES ) printf("SW: exception summary\n");
if ( status_word & SW_SF ) printf("SW: stack fault\n");
if ( status_word & SW_PE ) printf("SW: loss of precision\n");
if ( status_word & SW_UE ) printf("SW: underflow\n");
if ( status_word & SW_OE ) printf("SW: overflow\n");
if ( status_word & SW_ZE ) printf("SW: divide by zero\n");
if ( status_word & SW_DE ) printf("SW: denormalized operand\n");
if ( status_word & SW_IE ) printf("SW: invalid operation\n");
#endif DEBUGGING
