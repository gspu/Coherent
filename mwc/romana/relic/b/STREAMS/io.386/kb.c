 ...
 * io.386/kb.c
 *
 * non virtual terminal, nonloadable keyboard driver
 *
 * Revised: Fri Jul 30 08:08:03 1993 CDT
 */
 ...
 *	isfunction()	ispoll()	isrint()	isspecial()
 *	ismmfunc()	isin()		isbatch()	updleds()
 *	kbunscroll()
 */
...
int c;
{
	...
	case 64: case 65: case 66: case 67: case 68:
		...
		else { if( (shift & (SES)) && (shift & CTS)) /*ctl-shift-Fx*/
			cp = isfval[c-29];
		else { if(shift & CTS)			/* ctl-Fx */
			cp = isfval[c-39];
